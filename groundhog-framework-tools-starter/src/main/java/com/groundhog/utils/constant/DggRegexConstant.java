 ...
 * @Description: 正则常量类
 */
public interface DggRegexConstant {
    /******************** 正则相关常量 ********************/
    /**
     * 正则：手机号（简单）
     */
     ...
     * <p>虚拟运营商：170</p>
     */
    String REGEX_MOBILE_EXACT = "^((13[0-9])|(14[5-9])|(16[5-6])|(15[0-3,5-9])|(17[0-8])|(18[0-9])|(19[1,8-9]))\\d{8}$";
    /**
     * 正则：电话号码
     */
     ...
     * 正则：身份证号码15位
     */
    String REGEX_ID_CARD15 = "^[1-9]\\d{7}((0[1-9])|(10|11|12))(([0-2][1-9])|10|20|30|31)\\d{3}$";
    /**
     * 正则：身份证号码18位
     */
    String REGEX_ID_CARD18 = "^[1-9]\\d{5}[1-2]\\d{3}((0[1-9])|(10|11|12))(([0-2][1-9])|10|20|30|31)\\d{3}[0-9Xx]$";
    /**
     * 正则：邮箱
     */
     ...
     * 正则：URL
     */
    String REGEX_URL = "^(ht|f)tp(s?)://[0-9a-zA-Z]([-.\\w]*[0-9a-zA-Z])*(:(0-9)*)*(\\/?)[^\\s]*?$";
    /**
     * 正则：汉字
     */
    String REGEX_ZH = "^[\\u4e00-\\u9fa5]+$";
